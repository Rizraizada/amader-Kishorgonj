          ...
          <div class="col-lg-2" style="margin-top: 10px;">
             <div class="card mb-2" style="padding: 5px;">
               <div class="card-body text-center">
                 <img src="{{ asset('/uploads/images/lawyer/' . $primaryInfo['photo']) }}" alt="avatar" class="rounded-circle img-fluid" style="width: 130px;height:130px;" onerror="this.src='/uploads/images/Photo-Placeholder-Image-150x150-1.jpg'">
               </div>
             </div>
           </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-6" style="border-right: 1px solid #ccc;">
                    <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                        <span class="info-label" style="font-size: 15px;">মামলা পরিচালনার ক্ষেত্র :</span>
                        <span class="info-value" style="font-size: 13px;">   
                        @php
                             $expertiseIds = explode(',', optional($lawyerInfo)->expertise);
                         @endphp
                         
                         @foreach ($expertiseIds as $expertiseId)
                             {{ $expertiselawyer[$expertiseId] ?? '' }}
                             @if (!$loop->last)
                                 , 
                             @endif
                         @endforeach
                    ...
                    <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                        <span class="info-label" style="font-size: 15px;">আদালত :</span>
                        <span class="info-value" style="font-size: 13px;">{{ $court[optional($lawyerInfo)->court] ?? 'Not Found' }}</span>
                    </div>
                    <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                        <span class="info-label" style="font-size: 15px;">কাজের অভিজ্ঞতা(বছর) :</span>
                        <span class="info-value" style="font-size: 13px;">{{ optional($lawyerInfo)->experiences }}</span>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                        ...
                        <span class="info-value" style="font-size: 13px;">{{ $expertisedesignation[optional($lawyerInfo)->designation] ?? '' }}</span>
                    </div>
                    <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                        <span class="info-label" style="font-size: 15px;">বার কাউন্সিল সনদের নম্বর :</span>
                        <span class="info-value" style="font-size: 13px;">{{ optional($lawyerInfo)->bar_council_number }}</span>
                    </div>
                </div>
            </div>
        </div>
