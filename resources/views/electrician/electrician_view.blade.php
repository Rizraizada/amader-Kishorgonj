          ...
          <div class="col-lg-2" style="margin-top: 10px;">
             <div class="card mb-2" style="padding: 5px;">
               <div class="card-body text-center">
                 <img src="{{ asset('/uploads/images/electrician/' . $primaryInfo['photo']) }}" alt="avatar" class="rounded-circle img-fluid" style="width: 130px;height:130px;" onerror="this.src='/uploads/images/Photo-Placeholder-Image-150x150-1.jpg'">
               </div>
             </div>
           </div>
            ...
            <h4 class="mb-4 mt-6" style="border-bottom: 1px solid #1b8af3; margin-bottom: 20px; font-size: 21px; text-align:;">
              ...
              <div class="col-sm-6" style="border-right: 1px solid #ccc;">
                ...
                <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                    <span class="info-label" style="font-size: 15px;">কি কি কাজে অভিজ্ঞ:</span>
                           @if ($primaryInfo->electrician->expertise)
                                    {{ implode(', ', array_map(function ($value) use ($expertiseelectrician) {
                                        return $expertiseelectrician[$value] ?? 'N/A';
                                    }, explode(',', $primaryInfo->electrician->expertise))) }}
                                @else
                                    N/A
                                @endif
              ...
              <div class="col-sm-6">
                ...
                <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                  ...
                  @if ($primaryInfo->electrician)
                             {{ $primaryInfo->electrician->working_start_year ?? 'N/A' }}
                         @else
                             N/A
                         @endif
                </span>
