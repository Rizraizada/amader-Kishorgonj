              ...
              <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                      @if (auth()->guard('admin')->check())
                          ...
                          <li>
                              <a href="{{ route('adminLogout') }}" class="btn-login"><i
                                      class="fa fa-signout"></i>Logout</a>
                          </li>
                        <li>Logged in as <strong>{{ auth()->guard('admin')->user()->name }}</strong></li>
                      @elseif (auth()->check())
                          <li>
                              <a href="{{ route('userDashboard') }}" class="btn-login">User dashboard</a>
                          </li>
                          <li>
                              <a href="{{ route('userLogout') }}" class="btn-login"><i
                                      class="fa fa-signout"></i>Logout</a>
                          </li>
