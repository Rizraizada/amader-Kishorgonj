...
@section('content')
        ...
        <div class="container" style="text-align: center;">
            <div class="inner-box">
                <div class="text-box" style="position: relative;">
                    <h4 style="display: inline-block; font-size: 24px;">বিউটিশিয়ান রেজিস্ট্রেশন ফর্ম</h4>
                    <a href="/beautician"   class="btn-style-1"></i>বিউটিশিয়ানের
    ...
    <section class="resum-form padd-tb">
        <div class="container">
            ...
            {{-- dump($errors) --}}
            <form action="/beautician/registration" method="POST" enctype="multipart/form-data" id="beautician-form" data-parsley-validate="">
                @csrf
            ...
            $("form").submit(function (event) {
                ...
                .success(function(data){
                    if(data.status == 'success'){
                        ...
                        @endphp
                        window.location.assign('/beautician');
                    }
                    else {
