          ...
          <div class="col-lg-2" style="margin-top: 10px;">
             <div class="card mb-2" style="padding: 5px;">
               <div class="card-body text-center">
                 <img src="{{ asset('/uploads/images/barbar/' . $primaryInfo['photo']) }}" alt="avatar" class="rounded-circle img-fluid" style="width: 130px;height:130px;" onerror="this.src='/uploads/images/Photo-Placeholder-Image-150x150-1.jpg'">
               </div>
             </div>
           </div>
              ...
              <div class="col-sm-6" style="border-right: 1px solid #ccc;">
                ...
                <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                    <span class="info-label" style="font-size: 15px;">কি কি কাজে অভিজ্ঞ:</span>
                                             ...
                                             @if ($primaryInfo->barbar->expertise)
                             {{ implode(', ', array_map(function ($value) use ($expertisebarbar) {
                                 return $expertisebarbar[$value] ?? 'N/A';
                             }, explode(',', $primaryInfo->barbar->expertise))) }}
                         @else
                             N/A
                         @endif
              ...
              <div class="col-sm-6">
                ...
                <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                  ...
                  <span class="info-value" style="font-size: 13px;">  
                        @if ($primaryInfo->barbar)
                             {{ $primaryInfo->barbar->working_start_year ?? 'N/A' }}
                         @else
                             N/A
                         @endif
                  </span>
