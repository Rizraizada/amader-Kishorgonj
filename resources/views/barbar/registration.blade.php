...
@section('content')
        ...
        <div class="container" style="text-align: center;">
            <div class="inner-box">
                <div class="text-box" style="position: relative;">
                    <h4 style="display: inline-block; font-size: 24px;">নাপিত রেজিস্ট্রেশন ফর্ম</h4>
                    <a href="/barbar"   class="btn-style-1"></i>নাপিতের
    ...
    <section class="resum-form padd-tb">
        <div class="container">
                <div class="inner-box form-success hide" style="text-align: center;">
                    <div class="text-box" style="position: relative;">
                        <h5 class="alert alert-success">Successfully summitted.</h5>
                    </div>
                </div>
                <div class="inner-box form-error hide" style="text-align: center;">
                    <div class="text-box" style="position: relative;">
                        <h5 class="alert alert-danger">The form need proper data.</h5>
                    </div>
                </div>
            ...
            {{-- dump($errors) --}}
            <form action="/barbar/registration" method="POST" enctype="multipart/form-data" id="barbar-form" data-parsley-validate="">
                @csrf
    ...
    <script type="text/javascript">
        $(function () {
            $("form").submit(function (event) {
                ...
                .error(function(data){
                    // var dataResponse = data.responseJSON.errors;
                    // var objectKeys = Object.keys(dataResponse);
                    // if(objectKeys.length > 0) {
                    //    objectKeys.forEach(function(key, index) {
                    //         var fieldName = key;
