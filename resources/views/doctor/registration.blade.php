...
@section('content')
        ...
        <div class="container" style="text-align: center;">
            <div class="inner-box">
                <div class="text-box" style="position: relative;">
                    ...
                    <a href="/doctor"   class="btn-style-1"></i>ডাক্তারের
    ...
    <section class="resum-form padd-tb">
        <div class="container">
            ...
            {{-- dump($errors) --}}
            <form action="/doctor/registration" method="POST" enctype="multipart/form-data" id="doctor-form" data-parsley-validate="">
                @csrf
                ...
                <div class="row">
                    ...
                    @include('doctor.__partials.doctor_info')
                    @include('doctor.__partials.private_place')
                    @include('__partials.education')
                    @include('__partials.diploma_info')
                    ...
                    <input type="hidden" name="profession_type" value="1"><!-- profession -->
                    <div class="col-md-12">
                        <div class="btn-col">
