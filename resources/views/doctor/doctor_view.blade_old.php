                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6" style="border-right: 1px solid #ccc;">
                          <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                              ...
                              <span class="info-value" style="font-size: 13px;"> {{ $expertise->firstWhere('id', $primaryInfo->doctor->expertise) }}</span>
                          </div>
                          <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                              <span class="info-label" style="font-size: 15px;">হাসপাতাল/ক্লিনিকের নাম :</span>
                              <span class="info-value" style="font-size: 13px;">{{ $primaryInfo->doctor->clinic_name }}</span>
                          </div>
                          <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                              <span class="info-label" style="font-size: 15px;">কাজের অভিজ্ঞতা(বছর) :</span>
                              <span class="info-value" style="font-size: 13px;">{{ $primaryInfo->doctor->experiences }}</span>
                          </div>
                      </div>
                      <!-- Right Side -->
                      <div class="col-sm-6">
                          <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                              ...
                              <span class="info-value" style="font-size: 13px;">{{ $primaryInfo->doctor->designation }}</span>
                          </div>
                          <div class="info-item" style="border-bottom: 1px solid #ccc; margin-top: 10px;">
                              <span class="info-label" style="font-size: 15px;">বিএমডিসি নম্বর :</span>
                              <span class="info-value" style="font-size: 13px;">{{ $primaryInfo->doctor->bmdc_number }}</span>
                          </div>
                          <input type="hidden" name="type[]" value="2">
                      </div>
                  </div>
