        ...
        <div class="container" style="text-align: center;">
            <div class="inner-box">
                <div class="text-box" style="position: relative;">
                    <h4 style="display: inline-block; font-size: 24px;">ডাক্তার অনুসন্ধান</h4>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="job-box" style="width: 350px; height: 200px;">
                        <div class="box" style="padding: 20px;/* margin: 20px; */display: flex;/* width: 100%; */height: 80%;">
                            <div class="thumb" style="flex: 1;/* margin-right: 25px; *//* margin-left: -35px; *//* margin-top: -1px; */">
                                <a href="#"><img src="{{ asset('/uploads/images/doctor/' . $primaryInfo->photo) }}"
                            ...
                            <div class="text-col"
                                ...
                                <h4><a href="/doctor/details/{{ $primaryInfo->id }}" class="job-name"
                                ...
                                <h4>
                                    <p><i class="" style="color: #009900;"></i> <span class="job-consultant"
                                            style="color: #009900;">{{ isset($primaryInfo->doctor->expertise) ? $expertise[$primaryInfo->doctor->expertise] : '' }}</span>
                                    </p>
                                </h4> <!-- Set color to green (#009900) -->
                                ...
                                <p><i class="fa fa-clock"></i> <span
                                        class="job-experience">{{ $primaryInfo->doctor->experiences ?? '5 Years' }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
