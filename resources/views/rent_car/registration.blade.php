        ...
        <div class="container" style="text-align: center;">
            <div class="inner-box">
                <div class="text-box" style="position: relative;">
                    <h4 style="display: inline-block; font-size: 24px;">গাড়ীর রেজিস্ট্রেশন ফর্ম</h4>
                    <a href="/rent_car"   class="btn-style-1"></i>গাড়ীর
    ...
    <section class="resum-form padd-tb">
        <div class="container">
           @include('__partials.notification')
            ...
            {{-- dump($errors) --}}
            <form action="/rent_car/registration" method="POST" enctype="multipart/form-data" id="rent_car-form" data-parsley-validate="">
                @csrf
                ...
                <div class="row">
                    ...
                    @include('rent_car.__partials.info')
                    ...
                    <input type="hidden" name="profession_type" value="4"><!-- profession -->
                    <div class="col-md-12">
                        <div class="btn-col">
            ...
            $("form").submit(function (event) {
                ...
                .success(function(data){
                    if(data.status == 'success'){
                        ...
                        @endphp
                        window.location.assign('/rent_car');
                    }
                    else {
