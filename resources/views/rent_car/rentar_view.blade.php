          ...
          <div class="col-lg-2" style="margin-top: 10px;">
             <div class="card mb-2" style="padding: 5px;">
               <div class="card-body text-center">
                 <img src="{{ asset('/uploads/images/rent_car/' . $primaryInfo['photo']) }}" alt="avatar" class="rounded-circle img-fluid" style="width: 130px;height:130px;" onerror="this.src='/uploads/images/Photo-Placeholder-Image-150x150-1.jpg'">
               </div>
             </div>
           </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                        <tr>
                            <th style="border-bottom: 1px solid #ccc; font-size: 15px; margin-top: 10px;">গাড়ির ছবি</th>
                            <th style="border-bottom: 1px solid #ccc; font-size: 15px; margin-top: 10px;">গাড়ির ধরন</th>
                            <th style="border-bottom: 1px solid #ccc; font-size: 15px; margin-top: 10px;">ব্র্যান্ড</th>
                            <th style="border-bottom: 1px solid #ccc; font-size: 15px; margin-top: 10px;">সিট সংখ্যা</th>
                            <th style="border-bottom: 1px solid #ccc; font-size: 15px; margin-top: 10px;">মডেল</th>
                            <th style="border-bottom: 1px solid #ccc; font-size: 15px; margin-top: 10px;">রেজিস্ট্রেশন নম্বর</th>
                        </tr>
                        @foreach ($rentCars as $rentCar)
                            <tr>
                                <td>
                                   @if ($rentCar->car_pic)
                                   <img src="{{ asset('uploads/images/rent_car/' . $rentCar->car_pic) }}" alt="Car Picture" width="100" height="100">
                                   @else
                                       No Picture Available
                                   @endif
                               </td>
                                <td>{{ $expertiserent_car[$rentCar->car_type] ?? '' }}</td>
                                <td>{{ $rentCar->car_brand }}</td>
                                <td>{{ $rentCar->seat_number }}</td>
                                <td>{{ $rentCar->car_model }}</td>
                                <td>{{ $rentCar->car_reg_number }}</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
