@extends('layouts.layout')
    @section('content')
                ...
                <div class="container" style="text-align: center;">
                    <div class="inner-box">
                        <div class="text-box" style="position: relative;">
                            <h4 style="display: inline-block; font-size: 24px;">গাড়ী অনুসন্ধান করুন!</h4>
                            <a href="/rent_car/registration" class="btn-style-1"></i>গাড়ী রেজিস্ট্রেশন করতে ক্লিক করুন</a>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <section class="candidates-search-bar">
            <div class="container">
                <form action="/rent_car" id="rent_carSearch" style="background-color: #c0c2c4;">
                    <div class="row">
                            ...
                            <div class="col-md-4"style="margin-bottom: 15px;">
                                <div class="job-box" style="width: 350px; height: 200px;">
                                    <div class="box" style="padding: 20px;/* margin: 20px; */display: flex;/* width: 100%; */height: 80%;">
                                        ...
                                        <a href="#"><img src="{{ asset('/uploads/images/rent_car/car_pic/'.$car->car_pic) }}" alt="img" style="max-width:100%; height: 100%; border-radius: 25px;"></a>
                                        </div>
                                        <div class="text-col" style="flex: 2;text-align: left;/* padding-left: 60px; */border-radius: 25px;padding-left: inherit;">
                                        <h4><a href="#/rent_car/details/{{ $row->id}}" class="job-name" style="color: #ff6600;">{{ $row->name_bn }}</a></h4> <!-- Set color to orange (#ff6600) -->
                                        <p class="pt-4"><i class="fa fa-phone"></i> <a href="tel:{{ $row->mobile_no }}">{{ $row->mobile_no }}</a> <span class="job-phone"></span></p>
                                        <h4><p><i class="" style="color: #009900;"></i> <span class="job-consultant" style="color: #009900;">{{ isset($row->rent_car->expertise) ? $expertise[$row->rent_car->expertise] : '' }}</span></p></h4> <!-- Set color to green (#009900) -->
                                        ...
                                        @if($row->has('rent_car'))
                                            <p><i class="fa fa-car"></i> <span class="car">
                                                @if($car_types[$car->car_type])
...
@push('custom-js')
    <script>
        $(function () {
            $('#rent_carSearch').parsley().subscribe('parsley:form:validate', function (formInstance) {
