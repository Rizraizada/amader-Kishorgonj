...
class ElectricianController extends Controller
{
    public function index(Request $request) {
        $primaryInfo = PrimaryInfo::profession(6)
            ->with('addresses','electrician')
            ->active()
            ->orderBy('id', 'desc');
        ...
        if(isset($name) || isset($mobile_no) || isset($designation)) {
            ...
            if(isset($designation)) {
                ...
                $primaryInfo = $primaryInfo->whereHas('electrician',
        ...
        return view('electrician.index', compact('primaryInfo', 'expertise', 'name', 'mobile_no', 'designation'));
    }
    ...
    public function registrationForm()
    {
        ...
        return view('electrician.registration', compact('genders', 'religions', 'marital_status', 'divisions', 'blood_groups', 'exams', 'boards', 'expertise'));
    }
    ...
    public function registrationFormSubmit(Request $request)
    {
        ...
        $destination = public_path('/uploads/images/electrician');
        ...
        $primaryInfo->electrician()->create([
    ...
    public function details(int $id)
    {
        ...
        $expertise = DB::table("specializations")->where('type', 6)
            ->pluck('name','id');
        return view('electrician.details', compact('primaryInfo', 'expertise'));
    }
}
